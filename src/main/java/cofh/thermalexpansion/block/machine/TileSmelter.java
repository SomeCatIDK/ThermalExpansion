...
public class TileSmelter extends TileMachineBase {
	...
	protected boolean canStart() {
		...
		return inventory[2].isEmpty() || ItemHelper.itemsIdentical(inventory[2], primaryItem) && inventory[2].getCount() + (augmentPyrotheumCheck ? getPyrotheumOutputAmount(primaryItem) : primaryItem.getCount()) <= primaryItem.getMaxStackSize();
	}
